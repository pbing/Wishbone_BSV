...
//
// On Mon Feb 13 17:56:43 CET 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkWishboneMasterXactor_32_32_8(CLK,
  ...
  // ports of submodule m_ack_queue
  wire m_ack_queue$CLR, m_ack_queue$DEQ, m_ack_queue$EMPTY_N, m_ack_queue$ENQ;
  ...
  // value method wishbone_cyc
  assign CYC_O = m_io_req$EMPTY_N || m_state ;
  ...
  // submodule m_ack_queue
  SizedFIFO0 #(.p1depth(32'd8),
	       .p2cntr_width(32'd4),
	       .guarded(1'd0)) m_ack_queue(.RST(RST_N),
					   .CLK(CLK),
					   .ENQ(m_ack_queue$ENQ),
					   .DEQ(m_ack_queue$DEQ),
					   .CLR(m_ack_queue$CLR),
					   .FULL_N(),
					   .EMPTY_N(m_ack_queue$EMPTY_N));
  ...
  assign m_state$EN =
	     m_state && !m_io_req$EMPTY_N && !m_ack_queue$EMPTY_N ||
	     !m_state && m_io_req$EMPTY_N ;

  // submodule m_ack_queue
  assign m_ack_queue$ENQ = m_io_rsp$FULL_N && ACK_I ;
  assign m_ack_queue$DEQ = m_ack_queue$EMPTY_N ;
  assign m_ack_queue$CLR = 1'b0 ;

  // submodule m_io_req
  assign m_io_req$D_IN = server_request_put ;
  assign m_io_req$ENQ = EN_server_request_put ;
  assign m_io_req$DEQ = m_io_req$EMPTY_N ;
